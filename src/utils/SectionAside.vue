...
ul {
 ...
 li {
  @apply list-none m-0 text-base p-3 py-3 xl:text-sm hover:underline  hover:text-blue-500 hover:dark:text-blue-300 w-full;
 }

 @media (min-width: 640px) {
  /* styles for screens with a minimum width of 640px */
 }
