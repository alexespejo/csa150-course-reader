/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=clike+c+cpp&plugins=line-highlight+line-numbers */
var _self =
     ...
     A =
      g && m != g
       ? (function (e, t) {
          ...
          return (
           t.offsetTop + r(n.borderTopWidth) + r(n.paddingTop) - r(i.paddingTop)
          );
         })(o, g)
       : 0;
 ...
 if ("undefined" != typeof Prism && "undefined" != typeof document) {
  ...
  window.addEventListener("resize", function () {
   (t.assumeViewportIndependence && i === window.innerWidth) ||
    ((i = window.innerWidth),
    r(
     Array.prototype.slice.call(document.querySelectorAll("pre.line-numbers"))
    ));
  }),
